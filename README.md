...
11. once you have correctly entered the dates hit the **[ <kbd>Start Processing</kbd> ]** button on the bottom left of the window next to the **[ <kbd>Show Debug Window</kbd> ]** **Note:** the Show debug window button is only for finding problems with the application and you should not need it
12. after the processing is finished there should be a pop up saying the processing completed successfully click the **[ <kbd>okay</kbd> ]** button
13. now open the output file with whatever program you wish and check that your filtered data is there **Note:** if you kept the default it will have made the output in the input file folder with `_processed.csv` on the end of it
